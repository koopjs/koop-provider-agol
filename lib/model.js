...
const { koopProviderAgol: { host, maxCsvSize, fetchUserAgent } } = require('config')

const csvParse = promisify(parse)
const MAX_CSV_SIZE = Number(maxCsvSize) || 5000000
const FETCH_USER_AGENT = fetchUserAgent || 'Koop API'
