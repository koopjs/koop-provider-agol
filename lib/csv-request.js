...
var csvToGeojson = require('koop/lib').GeoJSON.fromCSV
var Csv = require('csv')
...
CSVRequest.prototype._convert = function (csv, callback) {
  csvToGeojson(csv, function (err, geojson) {
    if (err) {
...
CSVRequest.prototype._store = function (geojson, callback) {
  ...
  var table = {
    status: 'Cached',
    name: Utils.cleanseName(task.itemInfo.title),
